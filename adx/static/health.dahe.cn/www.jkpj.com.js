...
document.writeln('<link rel="stylesheet" type="text/css" href="http://static.adx.haomeit.com/static/health.puji/web/css/puji.css"/>');
(function(){
	$G.w={};
	$G.Config={
	...
	,	htmlStr:function(){
			var NewLine = '\n';
			var htmlS = '';
			htmlS+='<div class="cjjs_box" style="width:300px;height:250px;">'+NewLine;
			htmlS+='    <div class="dl_img" style="display:none;"><a href="{hrefUrl}" target="_blank"><img src="{filePath}" width="250" height="250"/></a></div>'+NewLine;
			htmlS+='    <div class="pj_main" style="display:block;">'+NewLine;
			htmlS+='<iframe src="{www}health.puji/web/health.puji.com1.html" frameborder="0" width="300" height="250" scrolling="no" marginheight="0" marginwidth="0"></iframe>';
			/*htmlS+='        <a class="block1 font13 po1_t0f0" href="http://jk.haomeit.com/renliu/?jkpj.com" name="style1" target="_blank">意外怀孕怎么办？</a>'+NewLine;
			htmlS+='        <a class="block1 font15 po1_t0fn" href="http://jk.haomeit.com/yangwei/?jkpj.com" name="style1" target="_blank">男人阳痿怎么办？</a>'+NewLine;
			htmlS+='        <a class="block3 font24 po1_tnf0" href="http://jk.haomeit.com/fukeyiy/?jkpj.com" name="style3" target="_blank">最好的妇科医院在哪儿？</a>'+NewLine;
			htmlS+='        <a class="block4 font15 po1_tn2f0" href="http://jk.haomeit.com/tongjing/?jkpj.com" name="style4" target="_blank">女性痛经怎么办？</a>'+NewLine;
			htmlS+='        <a class="block5 font16 po1_tn1fn1" href="http://http://jk.haomeit.com/zaoxie/?jkpj.com" name="style1" target="_blank">早泄怎么办？</a>'+NewLine;
			htmlS+='        <a class="block5 font15 po1_tn1f0" href="http://jk.haomeit.com/yunyu/?jkpj.com" name="style1" target="_blank">不孕不育怎么办？</a>'+NewLine;
			htmlS+='        <a class="block3 font24 po1_tn3f0" href="http://jk.haomeit.com/nanke/?jkpj.com" name="style3" target="_blank">最好的男科医院是哪家？</a>'+NewLine;
			htmlS+='        <a class="block2 font15 po1_tn4fn2" href="http://jk.haomeit.com/qianliexian/?jkpj.com" name="style2" target="_blank">前列腺炎怎么治？</a>'+NewLine;
			htmlS+='        <a class="block2 font15 po1_tn5fn3" href="http://jk.haomeit.com/baopigc/?jkpj.com" name="style2" target="_blank">包皮过长怎么办？</a>'+NewLine;*/
			htmlS+='    </div>'+NewLine;
			htmlS+='</div>'+NewLine;

			return htmlS.replace(/{www}/ig,$G.Config.www_static+'/');
		}
	...
	$G.wmImgs=function(selector){
		...
		var showFn=function(o){
				...
				var show=function(html,isTrue){
					var WinAltDom=$G('.TI2QT2P84ACJLI');
					WinAltDom[0].innerHTML=html;
					if(isTrue){
						$G('div:dl_img',WinAltDom[0]).show();
						$G('div:pj_main',WinAltDom[0]).none();
					}
				};
				var j=o.data[0]
				,	hrefUrl=o.targetUrl
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3Fd774fb701123f728c36007e3503ff9af' type='text/javascript'%3E%3C/script%3E"));
