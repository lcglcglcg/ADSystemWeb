...
(function(){
	...
	,	htmlStr250:function(){
			...
			n3+='<a name="{name}_colse" class="close_link"><img src="{www}anhao.cn/web/images/close_03.jpg" width="12" height="12"/></a>'+NewLine;
			...
			n3+='            <a class="block1 font13 po1_t0f0" href="http://jk.haomeit.com/renliu/?anhao.cn" name="style1" target="_blank">意外怀孕怎么办？</a>'+NewLine;
			n3+='            <a class="block1 font15 po1_t0fn" href="http://jk.haomeit.com/yangwei/?anhao.cn" name="style1" target="_blank">男人阳痿怎么办？</a>'+NewLine;
			n3+='            <a class="block3 font24 po1_tnf0" href="http://jk.haomeit.com/fukeyiy/?anhao.cn" name="style3" target="_blank">最好的妇科医院在哪儿？</a>'+NewLine;
			n3+='            <a class="block4 font15 po1_tn2f0" href="http://jk.haomeit.com/tongjing/?anhao.cn" name="style4" target="_blank">女性痛经怎么办？</a>'+NewLine;
			n3+='            <a class="block5 font16 po1_tn1fn1" href="http://http://jk.haomeit.com/zaoxie/?anhao.cn" name="style1" target="_blank">早泄怎么办？</a>'+NewLine;
			n3+='            <a class="block5 font15 po1_tn1f0" href="http://jk.haomeit.com/yunyu/?anhao.cn" name="style1" target="_blank">不孕不育怎么办？</a>'+NewLine;
			n3+='            <a class="block3 font24 po1_tn3f0" href="http://jk.haomeit.com/nanke/?anhao.cn" name="style3" target="_blank">最好的男科医院是哪家？</a>'+NewLine;
			n3+='            <a class="block2 font15 po1_tn4fn2" href="http://jk.haomeit.com/qianliexian/?anhao.cn" name="style2" target="_blank">前列腺炎怎么治？</a>'+NewLine;
			n3+='            <a class="block2 font15 po1_tn5fn3" href="http://jk.haomeit.com/baopigc/?anhao.cn" name="style2" target="_blank">包皮过长怎么办？</a>'+NewLine;
			n3+='        </div>'+NewLine;*/
			n3+='</div>'+NewLine;
	...
	$G.wmImgs=function(selector){
		...
		var showFn=function(o){
				...
				var dfData=function(){
					...
					var NewLine = '\n';
					var n1 = '';
					n1+='<div name="{name}" style="width:120px; height:240px; overflow:hidden; position:absolute; left:0; top:0;">'+NewLine;
					n1+='    	<div style="width:120px; height:240px; overflow:hidden; position:relative;">'+NewLine;
					n1+='        	<a name="{name}_colse" style=" position:absolute; right:0; top:0px;"><img src="{www}/anhao.cn/web/images/close_03.jpg" width="12" height="12" style="border:none;" /></a>'+NewLine;
					n1+='            <div style="display: none;width:120px; height:240px;"><a target="_blank" href="#" style="cursor: pointer;text-align: center;text-decoration: none;"><img width="120" height="240" src="../static/anhao.cn/web/images/img2.jpg" style="border:none;"></a></div>'+NewLine;
					n1+='            <div style="width:120px; height:240px; overflow:hidden; font-family:微软雅黑; font-size:18px;">'+NewLine;
					n1+='            	<a href="http://jk.haomeit.com/niupixuan/?anhao.cn" style=" display:block;height:240px; width:60px; float:left; background:#4675ad;color:#fff; text-decoration:none; cursor:pointer;" target="_blank"><i style=" display:block;width:20px; margin:0 auto; line-height:22px; text-align:center; font-style:normal; padding-top:35px; cursor:pointer;">牛皮癣会传染吗</i></a>'+NewLine;
					n1+='                <div style="width:59px; float:right; height:240px;">'+NewLine;
					n1+='                	<a href="http://jk.haomeit.com/xunmazhen/?anhao.cn" style="display:block; width:59px; height:120px; margin-bottom:1px; background:#349ca5;color:#fff; text-decoration:none; cursor:pointer;" target="_blank"><i style=" display:block;width:20px; margin:0 auto; font-size:13px;line-height:16px; text-align:center; font-style:normal; padding-top:2px; cursor:pointer;">荨麻疹能根治吗</i></a>'+NewLine;
					n1+='                	<a href="http://jk.haomeit.com/dx/?anhao.cn" style="display:block; width:59px; height:119px; background:#57a535;color:#fff; text-decoration:none; cursor:pointer;" target="_blank"><i style=" display:block;width:20px; margin:0 auto;font-size:13px;line-height:16px; text-align:center; font-style:normal; padding-top:8px; cursor:pointer;">癫痫能治愈吗</i></a>'+NewLine;
					n1+='                </div>'+NewLine;
					n1+='            </div>'+NewLine;
					n1+='        </div>'+NewLine;
					n1+='    </div>'+NewLine;
					...
					var n2 = '';
					n2+='<div name="{name}" style="width:120px; height:240px; overflow:hidden; position:absolute; top:0; right:0;">'+NewLine;
					n2+='    	<div style="width:120px; height:240px; overflow:hidden; position:relative;">'+NewLine;
					n2+='        	<a name="{name}_colse" style=" position:absolute; right:0; top:0px;"><img src="{www}/anhao.cn/web/images/close_03.jpg" width="12" height="12" style="border:none;"  /></a>'+NewLine;
					n2+='            <div style="display: none;width:120px; height:240px;"><a target="_blank" href="#" style="cursor: pointer;text-align: center;text-decoration: none;"><img width="120" height="240" src="../static/anhao.cn/web/images/img3.jpg" style="border:none;"></a></div>'+NewLine;
					n2+='            <div style="width:120px; height:240px; overflow:hidden; font-family:微软雅黑; font-size:21px;">'+NewLine;
					n2+='            	<a href="http://jk.haomeit.com/xiaoernt/?anhao.cn" style=" display:block;height:240px; width:60px; float:left; background:#a843a3;color:#fff; text-decoration:none;" target="_blank"><i style=" display:block;width:20px; margin:0 auto; line-height:22px; text-align:center; font-size:18px; font-style:normal; padding-top:45px; cursor:pointer;">脑瘫能治好吗</i></a>'+NewLine;
					n2+='                <div style="width:59px; float:right; height:240px;">'+NewLine;
				...
				$G.Each(function(i){
					...
					}else if(i==0 && WinAltDom.length>0){
						WinAltDom.WinAlt({
							position:'fixed',
							isLeft:true,
							isYCenter:true,
					...
					}else if(i==1 && WinAltDom.length>0){
						WinAltDom.WinAlt({
							position:'fixed',
							isRight:true,
							isYCenter:true,
...
(function(){
	var param={
		cabin:'TI21PIS74KID1M,TI2CB6PG4KID37,TI2HMNT04KID3K'
	,	param:{
			trust:5321
		,	style:'pic.www.duomeiti.cn'
		}
	,	callback:function(n){
		
		}
	};
	if(!is120240 && !is250250)return;
	$G.wmImgs.call(param);
})();
...
(function(){
	$G.wm=function(){
		...
		,	param={
			...
			//,	default_url:this.default_url||''			// 默认展示广告，暂时没用
			,	refer:statistics.fromPage
			,	title:wmObj.title?encodeURIComponent(wmObj.title):statistics.toPageTitle
			,	url:statistics.toPage
			,	mk:encodeURIComponent(wmObj.mk||mk||'')
			,	cb:'window.set'+uuid
			,	style:'www.duomeiti.cn'
			,	trust:5321
			}
		,	www='http://show.adx.haomeit.com'
...
(function(){
	...
	this.cabin='TL2OJEAQ4KID3C,TL2GCDDU4KID3E,TL218T2F4KID38';
	//广告显示后回调方法 n 为当前广告总数
