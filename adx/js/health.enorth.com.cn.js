...
document.writeln('<link rel="stylesheet" type="text/css" href="http://static.adx.haomeit.com/static/health.enorth.com.cn/web/css/enorth.css"/>');
(function(){
	$G.w={};
	$G.Config={
	...
	$G.wmImgs=function(selector){
		...
		var showFn=function(o){
				...
				var dfData=function(){
					...
					var NewLine = '\n';
					var h1 = '';
					h1+='<div name="{name}" style="overflow:hidden;" class="dl_box dl_box_nk">'+NewLine;
					h1+='        <a name="{name}_colse" class="close_link"><img src="{www}/health.enorth.com.cn/web/images/close_03.jpg" width="12" height="12"/></a>'+NewLine;
					h1+='        <div class="dl_img" style="display:none;"><a href="#" target="_blank"><img src="{www}/health.enorth.com.cn/web/images/img2.jpg" width="120" height="240"/></a></div>'+NewLine;
					h1+='        <div class="dl_main" style="display:block;">'+NewLine;
					h1+='            <a href="http://jk.haomeit.com/nanke/?health.enorth.com.cn" class="dl_a_link1 nk_blue font_size5" target="_blank"><i>最好的男科医院是哪家</i></a>'+NewLine;
					h1+='            <div class="dl_rg">'+NewLine;
					h1+='                <a href="http://jk.haomeit.com/yangwei/?health.enorth.com.cn" class="dl_a_link2 nk_light_blue font_size3" target="_blank"><i>男人阳痿怎么办</i></a>'+NewLine;
					h1+='                <a href="http://jk.haomeit.com/baopigc/?health.enorth.com.cn" class="dl_a_link3 nk_green font_size3" target="_blank"><i>包皮过长怎么办</i></a>'+NewLine;
					h1+='            </div>'+NewLine;
					h1+='        </div>'+NewLine;
					h1+='    </div>'+NewLine;
					
					var h2 = '';
					h2+='<div name="{name}" class="dl_box dl_box_fk">'+NewLine;
					h2+='        <a name="{name}_colse" class="close_link"><img src="{www}/jbk.99.com.cn/web/images/close_03.jpg" width="12" height="12"/></a>'+NewLine;
					h2+='        <div class="dl_img" style="display:none;"><a href="#" target="_blank"><img src="{www}/health.enorth.com.cn/web/images/img3.jpg" width="120" height="240"/></a></div>'+NewLine;
					h2+='        <div class="dl_main" style="display:block;">'+NewLine;
					h2+='            <a href="http://jk.haomeit.com/yindaoyan/?health.enorth.com.cn" class="dl_a_link1 fk_purple font_size5" target="_blank"><i>治疗阴道炎最好的医院</i></a>'+NewLine;
					h2+='            <div class="dl_rg">'+NewLine;
					h2+='                <a href="http://jk.haomeit.com/tongjing/?health.enorth.com.cn" class="dl_a_link2 fk_light_red font_size3" target="_blank"><i>女性痛经怎么办</i></a>'+NewLine;
					h2+='                <a href="http://jk.haomeit.com/renliu/?health.enorth.com.cn" class="dl_a_link3 fk_pink font_size3" target="_blank"><i>意外怀孕怎么办</i></a>'+NewLine;
					h2+='            </div>'+NewLine;
					h2+='        </div>'+NewLine;
					h2+='    </div>'+NewLine;
					

					array.push({html:h1.replace(/{www}/ig,$G.Config.www_static)});
					array.push({html:h2.replace(/{www}/ig,$G.Config.www_static)});
					return array;
				}();
				/*if($G.isNaN(o.data)){
...
(function(){
	var param={
		cabin:'TI1S0L8L4CE53E,TI2JGER54CE534'
	,	param:{
			trust:7086
		,	style:'health.enorth.com.cn'
		}
	,	callback:function(n){
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3F05049d951aee994cab4f3279ee5c2369' type='text/javascript'%3E%3C/script%3E"));
