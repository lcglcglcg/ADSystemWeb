...
document.writeln('<link rel="stylesheet" type="text/css" href="http://static.adx.haomeit.com/static/china.daily/web/css/daily.css"/>');
(function(){
	$G.w={};
	$G.Config={
	...
	,	htmlStr:function(){
			var NewLine = '\n';
			var temp = '';
			temp+='<div name="{name}" class="cjjs_box" style="width:250px;height:250px;">'+NewLine;
			temp+='        <a name="{name}_colse" class="close_link"><img src="{www}china.daily/web/images/close_03.jpg" width="12" height="12"/></a>'+NewLine;
			temp+='        <div class="dl_img" style="display:none;"><a href="{hrefUrl}" target="_blank"><img src="{filePath}" width="250" height="250"/></a></div>'+NewLine;
			temp+='        <div class="main" style="display:block;">'+NewLine;
			temp+='            <a class="block1 font13 po1_t0f0" href="http://jk.haomeit.com/renliu/?chinadaily" name="style1" target="_blank">意外怀孕怎么办？</a>'+NewLine;
			temp+='            <a class="block1 font15 po1_t0fn" href="http://jk.haomeit.com/yangwei/?chinadaily" name="style1" target="_blank">男人阳痿怎么办？</a>'+NewLine;
			temp+='            <a class="block3 font24 po1_tnf0" href="http://jk.haomeit.com/fukeyiy/?chinadaily" name="style3" target="_blank">最好的妇科医院在哪儿？</a>'+NewLine;
			temp+='            <a class="block4 font15 po1_tn2f0" href="http://jk.haomeit.com/tongjing/?chinadaily" name="style4" target="_blank">女性痛经怎么办？</a>'+NewLine;
			temp+='            <a class="block5 font16 po1_tn1fn1" href="http://http://jk.haomeit.com/zaoxie/?chinadaily" name="style1" target="_blank">早泄怎么办？</a>'+NewLine;
			temp+='            <a class="block5 font15 po1_tn1f0" href="http://jk.haomeit.com/yunyu/?chinadaily" name="style1" target="_blank">不孕不育怎么办？</a>'+NewLine;
			temp+='            <a class="block3 font24 po1_tn3f0" href="http://jk.haomeit.com/nanke/?chinadaily" name="style3" target="_blank">最好的男科医院是哪家？</a>'+NewLine;
			temp+='            <a class="block2 font15 po1_tn4fn2" href="http://jk.haomeit.com/qianliexian/?chinadaily" name="style2" target="_blank">前列腺炎怎么治？</a>'+NewLine;
			temp+='            <a class="block2 font15 po1_tn5fn3" href="http://jk.haomeit.com/baopigc/?chinadaily" name="style2" target="_blank">包皮过长怎么办？</a>'+NewLine;
			temp+='        </div>'+NewLine;
			temp+='    </div>'+NewLine;
	...
	$G.wmImgs=function(selector){
		...
		var showFn=function(o){
				...
				var show=function(html,isTrue){
					var reg=wrParam('name','TI2QDIM64ACI30');
					html=html.replace(reg.key,reg.val);
					var div=document.createElement('div');
					div.innerHTML=html;
					document.body.appendChild(div);
					var WinAltDom=$G('.TI2QDIM64ACI30');
					if(isTrue){
					...
					$G('.TI2QDIM64ACI30_colse').click(function(){
...
(function(){
	var param={
		cabin:'TI2QDIM64ACI30'
	,	param:{
			trust:7086
		,	style:'heb.chinadaily.com.cn'
		}
	,	callback:function(n){
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3F069e4785ad5c997b89de4570ee69cae3' type='text/javascript'%3E%3C/script%3E"));
