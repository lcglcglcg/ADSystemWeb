...
(function(){
	...
	,	htmlStr:function(){
			return '<div name="{name}" style="width:120px; height:270px; overflow:hidden;"><a name="{name}_colse" style="position:absolute; right:0; top:0px;"><img src="{www}close_03.jpg" width="12" height="12" /></a><div style="width:120px; height:240px; overflow:hidden;"><a target="_blank" href="{hrefUrl}" style="text-decoration:none; cursor:pointer;"><img src="{filePath}" width="120" height="240" /></a></div>\
    	<a target="_blank" href="{webIM}" style="display:block; cursor:pointer;width:120px; height:30px;text-decoration:none; overflow:hidden;"><img src="{www}zixun.gif" width="120" height="30" /></a></div>'.replace(/{www}/ig,$G.Config.www_static+'/');
		}
	...
	$G.wmImg=function(selector){
		...
		var showFn=function(o){
				...
				var dfData=function(){
					var array=new Array();
					array.push({isTrue:true,imgSize:'120X240',webIM:'http://online.15talk.haomeit.com/online/pages/web/totalk.jsp?LeXun=KSFNWPPSYPUH',destinationUrl:'http://www.913wen.com/nanke/?913wen',filePath:'http://static.adx.haomeit.com/images/jbk_99_com_cn/nanke.jpg'});
					array.push({isTrue:true,imgSize:'120X240',webIM:'http://online.15talk.haomeit.com/online/pages/web/totalk.jsp?LeXun=KSFNWPPSYPUH',destinationUrl:'http://www.913wen.com/fukeyiy/?913wen',filePath:'http://static.adx.haomeit.com/images/jbk_99_com_cn/fukeyiy.jpg'});
					return array;
				}();
				if($G.isNaN(o.data)){
					o.data=[{targetUrl:'http://www.913wen.com/nanke/?913wen'}];
				}
				if(o.data.length<1){
					o.data=dfData;
				}else{
