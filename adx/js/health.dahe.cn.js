...
document.writeln('<link rel="stylesheet" type="text/css" href="http://static.adx.haomeit.com/static/health.dahe.cn/web/css/dahe.css"/>');
	...
	$G.wmImgs=function(selector){
		...
		var showFn=function(o){
				...
				var dfData=function(){
					...
					var NewLine = '\n';
					var nankeyHtml = '';
					nankeyHtml+='<div name="{name}" style="width:120px; height:270px; overflow:hidden;" class="dl_box dl_box_nk">'+NewLine;
					nankeyHtml+='        <a href="#" class="close_link"><img src="{www}/health.enorth.com.cn/web/images/close_03.jpg" width="12" height="12"/></a>'+NewLine;
					nankeyHtml+='      <div class="dl_main" style="display:block;">'+NewLine;
					nankeyHtml+='            <a href="http://jk.haomeit.com/waiyinsaoyang/?dahe" class="dl_a_link1 nk_blue font_size5" target="_blank"><i class="pad1">外阴瘙痒怎么缓解</i></a>'+NewLine;
					nankeyHtml+='            <div class="dl_rg">'+NewLine;
					nankeyHtml+='                <a href="http://jk.haomeit.com/qianliexian/?dahe" class="dl_a_link2_1 nk_light_blue font_size3" target="_blank"><i>前列腺炎能根治吗</i></a>'+NewLine;
					nankeyHtml+='                <a href="http://jk.haomeit.com/tongjing/?dahe" class="dl_a_link3_1 nk_green font_size3" target="_blank"><i>痛经怎么办</i></a>'+NewLine;
					nankeyHtml+='            </div>'+NewLine;
					nankeyHtml+='        </div>'+NewLine;
					nankeyHtml+='    </div>'+NewLine;
					
					var fukeHTML = '';
					fukeHTML+='<div name="{name}" style="width:120px; height:270px; overflow:hidden;"  class="dl_box dl_box_fk">'+NewLine;
					fukeHTML+='        <a href="#" class="close_link"><img src="{www}/jbk.99.com.cn/web/images/close_03.jpg" width="12" height="12"/></a>'+NewLine;
					fukeHTML+='        <div class="dl_main" style="display:block;">'+NewLine;
					fukeHTML+='            <a href="http://jk.haomeit.com/yuejingbt/?dahe" class="dl_a_link1 fk_purple font_size5" target="_blank"><i class="pad1">月经不调怎么调理</i></a>'+NewLine;
					fukeHTML+='            <div class="dl_rg">'+NewLine;
					fukeHTML+='                <a href="http://jk.haomeit.com/yunyu/?dahe" class="dl_a_link2 fk_light_red font_size3" target="_blank"><i>不孕不育怎么办</i></a>'+NewLine;
					fukeHTML+='                <a href="http://jk.haomeit.com/zaoxie/?dahe" class="dl_a_link3 fk_pink font_size3" target="_blank"><i class="pad2">早泄可以治么</i></a>'+NewLine;
					fukeHTML+='            </div>'+NewLine;
					fukeHTML+='        </div>'+NewLine;
					fukeHTML+='    </div>'+NewLine;
					
					array.push({html:nankeyHtml.replace(/{www}/ig,$G.Config.www_static)});
					array.push({html:fukeHTML.replace(/{www}/ig,$G.Config.www_static)});
					return array;
				}();
				/*if($G.isNaN(o.data)){
...
(function(){
	var param={
		cabin:'TI26U20N34SMRP,TI2TN8P834SM4J'
	,	param:{
			trust:7086
		,	style:'health.dahe.cn.pc'
		}
	,	callback:function(n){
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3Fe9cfb66f6144da42f8c801b44c95c3d0' type='text/javascript'%3E%3C/script%3E"));
