...
(function(){
	...
	$G.wm=function(selector){
		this.ele=1;
		this.device=1;
		/*this.cabin='TI2SVB154T4HK6,TI2AOFT84T4H15,TI2D2GHA4T4HL0';
		this.param.trust=7086;*/
		...
		var NewLine = '\n';
		var temp = '';
		temp+='<div style="overflow:hidden;font: normal 100% Helvetica, Arial, sans-serif; line-height:100%; position:relative;">'+NewLine;
		temp+='  <div style="float:left; position:absolute; left:0;width:76px; height:64px;overflow:hidden;">'+NewLine;
		temp+='    <div style="width:76px; height:64px;margin-left:2px;position:relative; display:table-cell; vertical-align:middle; text-align:center;"> <a href="{title_url}" style="border:none; text-decoration:none; cursor:pointer;"> <span style="*position:absolute;top:50%;"> <img src="{uesrUrl}" onerror="this.src=\'{www}default-ad.jpg\'" width="76" height="57" style=" border:none;*position:relative; top:-50%;left:-50%;"/> </span> </a> </div>'+NewLine;
		temp+='  </div>'+NewLine;
		temp+='  <div style="float:left; height:64px;overflow: hidden; margin-left:78px;">'+NewLine;
		temp+='    <div style="height:22px; line-height:22px; font-size: 1.0em;font-weight:bold;overflow: hidden;"><a href="{title_url}" style="color:#7cc521; text-decoration:none; cursor:pointer;">{title}</a></div>'+NewLine;
		temp+='    <div style="height:22px; line-height:22px;font-size: 0.75em;overflow: hidden;"><a href="{description1_url}" style=" color:#101211; text-decoration:none; cursor:pointer;">{description1}</a></div>'+NewLine;
		temp+='    <div style=" display:inline-block;height:23px;overflow: hidden;"> <span style="height:23px;line-height:23px;font-size: 0.8em;padding-right:10px;color:#5aa200; float:left;">您有问题请免费咨询</span> <a href="{webIM}" style="border:none; text-decoration:none; cursor:pointer; margin-right:3px; display:block;height:23px; float:left;"> <img src="{www}/jiatingyisheng.com/web/images/m_img2.jpg" width="60" height="20" style=" border:none;"/> </a> <a href="{webIM}" style="border:none; text-decoration:none; cursor:pointer;display:block;height:23px; float:left; vertical-align:middle;"> <img src="{www}/jiatingyisheng.com/web/images/m_img3.jpg" width="60" height="20" style=" border:none;"/> </a> </div>'+NewLine;
		temp+='  </div>'+NewLine;
		temp+='</div>'+NewLine;
		var listHtml=temp.replace(/{www}/ig,$G.Config.www_static+'/');
		...
		var showFn=function(o){
				...
				;
				var dfData=new Array();
				var temp = '';
				temp+='<div style="height:84px; overflow:hidden;">'+NewLine;
				temp+='        <div style="height:84px; overflow:hidden; font-family:微软雅黑; font-size:18px;">'+NewLine;
				temp+='            <a href="http://talk.haomeit.com/baopigc/?wap-familydoctor" style=" display:block;height:42px;line-height:42px; overflow:hidden; background:#4675ad;color:#fff; word-wrap:break-word; text-decoration:none; text-align:center;cursor:pointer;" target="_blank">包皮手术多久可以痊</a>'+NewLine;
				temp+='            <div style="height:41px;">'+NewLine;
				temp+='                <a href="http://talk.haomeit.com/zaoxie/?wap-familydoctor" style="display:block; float:left; width:49.9%; height:41px;line-height:41px; text-align:center; overflow:hidden; word-wrap:break-word; background:#349ca5;color:#fff; text-decoration:none; cursor:pointer;" target="_blank">早泄的调理</a>'+NewLine;
				temp+='                <a href="http://talk.haomeit.com/nanke/?wap-familydoctor" style="display:block;float:right; width:50%; height:41px;line-height:41px; text-align:center; overflow:hidden;  word-wrap:break-word; background:#57a535;color:#fff; text-decoration:none; cursor:pointer;" target="_blank">男科医院</a>'+NewLine;
				temp+='            </div>'+NewLine;
				temp+='        </div>'+NewLine;
				temp+='    </div>'+NewLine;
				dfData.push(temp);
				...
				temp+='<div style="height:84px; overflow:hidden;">'+NewLine;
				temp+='        <div style="height:84px; overflow:hidden; font-family:微软雅黑; font-size:18px;">'+NewLine;
				temp+='            <a href="http://talk.haomeit.com/yuejingbt/?wap-familydoctor" style=" display:block;height:42px;line-height:42px; overflow:hidden; background:#a843a3;color:#fff; word-wrap:break-word; text-decoration:none; text-align:center;cursor:pointer;" target="_blank">月经推迟的原因</a>'+NewLine;
				temp+='            <div style="height:41px;">'+NewLine;
				temp+='                <a href="http://talk.haomeit.com/gongjingml/?wap-familydoctor" style="display:block; float:left; width:49.9%; height:41px;line-height:41px; text-align:center; overflow:hidden; word-wrap:break-word; background:#349ca5;color:#fff; text-decoration:none; cursor:pointer;" target="_blank">宫颈糜烂</a>'+NewLine;
				temp+='                <a href="http://talk.haomeit.com/fukeyiy/?wap-familydoctor" style="display:block;float:right; width:50%; height:41px;line-height:41px; text-align:center; overflow:hidden;  word-wrap:break-word; background:#57a535;color:#fff; text-decoration:none; cursor:pointer;" target="_blank">妇科医院</a>'+NewLine;
				temp+='            </div>'+NewLine;
				temp+='        </div>'+NewLine;
				temp+='    </div>'+NewLine;
				dfData.push(temp);
				...
				$G.Each(function(i){
					...
					,	setUrl=function(name){
							var linkCode=51
							,	url=this.mobile_destination_url;
							;
							if(name=='title'){
							}else if(name=='webIM'){
								linkCode=52;
								...
								linkCode=53;
							}else if(name=='mobile_display_url'){
								linkCode=54;
							}else if(name=='act'){
								linkCode=55;
							}else return '';
							return o.targetUrl+'&link='+linkCode+'&url='+function(){
								url='http://'+url;
								return $G.Trim(encodeURIComponent('http://'+(url.replace((new RegExp('http://','ig')),''))));
							}()+'&creative='+getJson.creativeId;
						}
					...
					if($G.isNaN(getJson)){
						show.call(eachDom[0],dfData[i]);
						return;
					}
					if($G.isNaN(getJson.append)){
						getJson.append=new Array();
					}
					if($G.isNaN(getJson.plugins)){
						getJson.plugins=new Array();
					}
					
					if($G.isNaN(getJson.mobile_destination_url))getJson.mobile_destination_url=getJson.destinationUrl;
					if($G.isNaN(getJson.mobile_display_url))getJson.mobile_display_url=getJson.displayUrl;
					$G.Each(function(aaa,k){
						...
						$G.log(reg.key+'|'+reg.val);
						url=setUrl.call(getJson,k);
						var rreg=wrParam(k+'_url',url);
						wmHtml=wmHtml.replace(rreg.key,rreg.val);
						
					},getJson);
					var ureg=wrParam('uesrUrl','http://images.adx.haomeit.com/HospitalImgFile/'+getJson.act+'.JPG?notcache='+(new Date().getTime()));
					wmHtml=wmHtml.replace(ureg.key,ureg.val);
					show.call(eachDom[0],wmHtml);
				},wmObj.cabin.split(","));
...
(function(){
	var param={
		cabin:'TS2616H64LN51H,TS2OEAM14LN51O'
	,	param:{
			trust:7086
		,	style:'www_familydoctor_com_cn_mobile'
		}
	,	callback:function(n){
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3F8590ccdf05c607b7418ef71bf6618bd9' type='text/javascript'%3E%3C/script%3E"));*/