...
;
var pcCode=new Array()
,	mbCode=new Array()
;
pcCode.push('%3Fd9ea9d8cfa586db93d3ad714f853d352');
pcCode.push('%3Fa872e76fec1eca6d10cd56adb503fed3');
pcCode.push('%3F341609a7079213c35e7bcdd41ab303e9');
pcCode.push('%3Fff52f546c8e68e616fb4e68b43d93975');
pcCode.push('%3F36a3389ecdadf7a485933d07cc831415');
mbCode.push('%3F6162ccd21237727165fc4c7221af7f60');
mbCode.push('%3Fa872e76fec1eca6d10cd56adb503fed3');
mbCode.push('%3F341609a7079213c35e7bcdd41ab303e9');
mbCode.push('%3Fff52f546c8e68e616fb4e68b43d93975');
mbCode.push('%3F36a3389ecdadf7a485933d07cc831415');

var hmCode='';
if($G.mobile){
	hmCode=mbCode[window.wmTop-1];
}else{
	hmCode=pcCode[window.wmTop-1];
}
var url=window.document.location.hostname;
	if(url=='taipy.haomeit.com')
		hmCode='%3Fd8d354c04d6f6a8fccb32ec4b20f3bc7';
	else if(url=='tj.99wen.cn'){
		var _hmt = _hmt || [];
		(function() {
		  var hm = document.createElement("script");
		  hm.src = "//hm.baidu.com/hm.js?6bfb6841eec92a0a6ea754531e6087b0";
...
var isYibo=document.location+''
,	isYiboTrue=isYibo.indexOf('?yibo')
;
if(isYiboTrue>0){
	var _adwq = _adwq || []; 
    _adwq.push(['_setAccount', 'vke48']); 
    _adwq.push(['_setDomainName', 'pclady.linkidea.cn']); 
...
if(url=='pclady.linkidea.cn'){
	(function() {
		var c = document.createElement('script');
		c.type = 'text/javascript';
		c.async = true;
		c.src = 'http://static.atm.youku.com/20150701/p.main.js';
		var h = document.getElementsByTagName('script')[0];
		h.parentNode.insertBefore(c, h);
	})();

	$G.getjs({
		url:'http://static.atm.youku.com/20150701/cm.js',
		callback:function(){
			window.YK_CLIENT_ID = 11167;
			YK_DMP.trackPdmp('24');
		},
		charset:'utf-8'
	});
}
if(url=='pclady.linkidea.cn' && 1>2) {
	window._CWiQ = window._CWiQ || [];
	window.BX_CLIENT_ID = 35925; // 帐号ID
	(function() {
		var c = document.createElement('script')
		,p = 'https:'==document.location.protocol;
		c.type = 'text/javascript';
		c.async = true;
		c.src = (p?'https://':'http://')+'land.dsp.youku.com/boot/0';
		var h = document.getElementsByTagName('script')[0];
		h.parentNode.insertBefore(c, h);
	})();
}
(function(){
	var locatUrl=document.location+''
	,	locatUrlLen=locatUrl.indexOf('jiankang.58.com')
	,	leftTest='<div class="hos_title">好媒体健康提示您：</div><div class="hos_word">为了保护您的健康，如发现身体有不适症状，可以通过本页免费咨询通道，与医院在线专家一对一免费交流沟通病情，也可以在线预约挂号！</div>'
	;
	if(locatUrlLen<0){
		$G('.logo').Each(function(){
			this.src='/static/jk.haomeit.com/web/images/m_logo.jpg';
		});
	}else{
		$G('.logo').Each(function(){
			this.src='/static/58.com/web/images/58-logo.gif';
		});
		leftTest='<div class="hos_title">温馨提示：</div><div class="hos_word">为了您的身体健康，如发现身体有不适症状，请选择正规医院与医生一对一沟通了解病情，祝君健康！</div>';
	}
	...
	$G.wm=function(){
		...
		,	isBilling=function(){
				...
				if(referUrlLen<0)referUrlLen=referUrl.indexOf('?58sg');
		...
		,	url=www+'/pass?'+function(){
				...
				var styles='jk.haomeit.com1';
				if($G.mobile){
					styles='m.jk.haomeit.com1';
				}
				return styles;
...
<div class="hos_zixun"><a target="_blank" href="<!--webIM-->&link=2"><img src="{www}jk.haomeit.com/web/images/media-07.jpg" width="130" height="121" /><br />\
  <u>免费在线挂号</u></a></div>\
<div class="hos_content">'+leftTest+'</div>').replace(/{www}/ig,www_static+'/')
		,	showFn=function(o){
				o=o||{};
				wmObj=this;
				...
				if(o.data.length<1){
					...
					;
					if($G.mobile){
						var lhUrl=window.location.hostname
						;
						if(lhUrl.indexOf('so.913wen.com')<0&&lhUrl.indexOf('jk.haomeit.com')<0)
...
(function(){
	...
	this.cabin='TL1PQ2V2576O2R,TL274MSP4KU21F,TL1QE67C4KUD1P,TL1V2J5C4KUL2U,TL2A06JG4KUT28';
	//广告显示后回调方法 n 为当前广告总数
