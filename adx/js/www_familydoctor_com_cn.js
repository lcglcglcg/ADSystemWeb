(function(){
	...
	window.wmConfig=function(){
		...
		*******************************/
		...
		if(window.wmPic){
			...
			;
			$G.wm({
				cabin:'TI2SVB154T4HK6,TI2AOFT84T4H15,TI2D2GHA4T4HL0' 	//广告位标识
			,	style:'pic.www.familydoctor.com.cn'//页面标识广告以哪种风格显示，便于日志数据分析
		...
		if(window.wmTest){
			...
			;
			$G.wm({
				cabin:'TL2NJVSO33BC1K,TL2SG68J33BC1Q,TL2P4PE933BC27' 	//广告位标识
			,	style:'test.www.familydoctor.com.cn'//页面标识广告以哪种风格显示，便于日志数据分析
			,	fn:function(d){
					/****以下为封闭好后的广告JSON对象数据.		注：每一条广告数据，执行一次此方法****/
					/*	
						cabin:广告标识
	...
	*******************************************************************/
	...
	//getjs({url:_bdhmProtocol + "hm.baidu.com/h.js%3F8590ccdf05c607b7418ef71bf6618bd9"});
})();