...
(function(){
	$G.wm=function(){
		...
		,	url=www+'/pass?style=m.58.com2&device=1&'+$G.param(param)+'&cabin='+(wmObj.cabin||'')						// 广告位标识
...
<div style="float:left; height:64px;overflow: hidden; margin-right:78px;">\
  <div style="height:22px; line-height:22px; font-size: 16px;overflow: hidden;">{title}</div>\
  <div style="height:24px; line-height:24px;font-size: 12px;overflow: hidden;">{description1}</div>\
  <div style=" display:inline-block;height:20px;line-height:20px;font-size: 0.8em;overflow: hidden;padding-right:25px;">{mobile_display_url}</div>\
</div>\
  ...
  <div style="width:68px; height:64px; margin-left:2px;position:relative; display:table-cell; vertical-align:middle; text-align:center;">{webIM}</div>\
		...
		,	showFn=function(o){
				...
				,	clickList={
						'title':{
							'link':11
						,	'css':'color:#333333; text-decoration:none; cursor:pointer;font-family:微软雅黑;'
						}
					,	'webIM':{
							'link':12
						,	'css':'border:none; text-decoration:none; cursor:pointer;'
						,	'key':'webIM'
						,	'val':'<span style="*position:absolute;top:50%;"> <img src="{www}58.com/web/images/com2_01.jpg"  width="58" height="32" /> </span>'.replace(/{www}/ig,www_static+'/')
						}
					,	'description1':{
							'link':13
						,	'css':'color:#AAAFBA; text-decoration:none; cursor:pointer;font-family:微软雅黑;'
						}
					,	'mobile_display_url':{
							'link':14
						,	'css':'color:#5f9bf8;text-decoration:none; cursor:pointer;'
						}
					}
