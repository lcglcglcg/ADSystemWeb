...
document.writeln('<link rel="stylesheet" type="text/css" href="http://static.adx.haomeit.com/static/half.a.month/web/css/month.css"/>');
document.writeln('<link rel="stylesheet" type="text/css" href="http://static.adx.haomeit.com/static/half.a.month/web/css/month_dl.css"/>');
(function(){
	$G.w={};
	$G.Config={
	...
	,	www_static:'http://static.adx.haomeit.com/static'
	...
	,	htmlStr:function(){
			var NewLine = '\n';
			var temp = '';
			temp+='<div name="{name}" style="width:120px; height:240px; overflow:hidden; position:relative;"> <a name="{name}_colse" style=" position:absolute; right:0px; top:0px; z-index:999; border:none;"><img src="{www}health.dahe.cn/web/images/close_03.jpg" width="12" height="12" /></a> <a href="{hrefUrl}" style="text-decoration:none; cursor:pointer;" target="_blank"><img src="{filePath}" width="120" height="240" /></a> </div>'+NewLine;

			return temp.replace(/{www}/ig,$G.Config.www_static+'/');
		}
	...
	,	htmlStr250:function(){
			var NewLine = '\n';
			var n3 = '';
			n3+='<div name="{name}" class="cjjs_box" style="width:250px;height:250px;">'+NewLine;
			n3+='    <a name="{name}_colse"  class="close_link"><img src="{www}half.a.month/web/images/close_03.jpg" width="12" height="12"/></a>'+NewLine;
			n3+='    <div class="dl_img" style="display:none;"><a href="{hrefUrl}" target="_blank"><img src="{filePath}" width="250" height="250"/></a></div>'+NewLine;
			n3+='    <div class="main" style="display:block;">'+NewLine;
			n3+='<a href="http://jk.haomeit.com/zhengxing/?banyuetan" target="_blank"><img src="{www}half.a.month/web/images/img4.jpg" width="250" height="250"/></a>';
			/*n3+='        <a class="block1 font13 po1_t0f0" href="http://jk.haomeit.com/renliu/?banyuetan" name="style1" target="_blank">意外怀孕怎么办？</a>'+NewLine;
			n3+='        <a class="block1 font15 po1_t0fn" href="http://jk.haomeit.com/yangwei/?banyuetan" name="style1" target="_blank">男人阳痿怎么办？</a>'+NewLine;
			n3+='        <a class="block3 font24 po1_tnf0" href="http://jk.haomeit.com/fukeyiy/?banyuetan" name="style3" target="_blank">最好的妇科医院在哪儿？</a>'+NewLine;
			n3+='        <a class="block4 font15 po1_tn2f0" href="http://jk.haomeit.com/tongjing/?banyuetan" name="style4" target="_blank">女性痛经怎么办？</a>'+NewLine;
			n3+='        <a class="block5 font16 po1_tn1fn1" href="http://http://jk.haomeit.com/zaoxie/?banyuetan" name="style1" target="_blank">早泄怎么办？</a>'+NewLine;
			n3+='        <a class="block5 font15 po1_tn1f0" href="http://jk.haomeit.com/yunyu/?banyuetan" name="style1" target="_blank">不孕不育怎么办？</a>'+NewLine;
			n3+='        <a class="block3 font24 po1_tn3f0" href="http://jk.haomeit.com/nanke/?banyuetan" name="style3" target="_blank">最好的男科医院是哪家？</a>'+NewLine;
			n3+='        <a class="block2 font15 po1_tn4fn2" href="http://jk.haomeit.com/qianliexian/?banyuetan" name="style2" target="_blank">前列腺炎怎么治？</a>'+NewLine;
			n3+='        <a class="block2 font15 po1_tn5fn3" href="http://jk.haomeit.com/baopigc/?banyuetan" name="style2" target="_blank">包皮过长怎么办？</a>'+NewLine;*/
			n3+='    </div>'+NewLine;
			n3+='</div>'+NewLine;
			
			return n3.replace(/{www}/ig,$G.Config.www_static+'/');
		}
	,	ini:function(selector){
			var uuid=$G.uuidFast().replace(/-/ig,'')
			,	param=$G.Config.param.call(this,'',uuid)
	...
	$G.wmImgs=function(selector){
		...
		var showFn=function(o){
				...
				var dfData=function(){
					...
					var NewLine = '\n';
					var n1 = '';
					n1+='<div name="{name}" class="dl_box dl_box_nk">'+NewLine;
					n1+='        <a name="{name}_colse"  class="close_link"><img src="http://static.adx.haomeit.com/static/half.a.month/web/images/close_03.jpg" width="12" height="12"/></a>'+NewLine;
					n1+='        <div class="dl_img" style="display:none;"><a href="#" target="_blank"><img src="http://static.adx.haomeit.com/static/half.a.month/web/images/img2.jpg" width="120" height="240"/></a></div>'+NewLine;
					n1+='        <div class="dl_main" style="display:block;">'+NewLine;
					n1+='<a href="http://jk.haomeit.com/renliu/?banyuetan" target="_blank"><img src="http://static.adx.haomeit.com/static/half.a.month/web/images/img5.gif" width="120" height="240"/></a>';
					/*n1+='            <a href="http://jk.haomeit.com/niupixuan/?banyuetan" class="dl_a_link1 nk_blue font_size1" target="_blank"><i>牛皮癣会传染吗</i></a>'+NewLine;
					n1+='            <div class="dl_rg">'+NewLine;
					n1+='                <a href="http://jk.haomeit.com/dx/?banyuetan" class="dl_a_link2 nk_light_blue font_size2" target="_blank"><i>癫痫能治愈吗</i></a>'+NewLine;
					n1+='                <a href="http://jk.haomeit.com/xunmazhen/?banyuetan" class="dl_a_link3 nk_green font_size3" target="_blank"><i>荨麻疹能根治吗</i></a>'+NewLine;
					n1+='            </div>'+NewLine;*/
					n1+='        </div>'+NewLine;
					n1+='    </div>'+NewLine;
					
					var n2 = '';
					n2+='<div name="{name}" class="dl_box dl_box_fk">'+NewLine;
					n2+='        <a name="{name}_colse"  class="close_link"><img src="http://static.adx.haomeit.com/static/half.a.month/web/images/close_03.jpg" width="12" height="12"/></a>'+NewLine;
					n2+='        <div class="dl_img" style="display:none;"><a href="#" target="_blank"><img src="http://static.adx.haomeit.com/static/half.a.month/web/images/img3.jpg" width="120" height="240"/></a></div>'+NewLine;
					n2+='        <div class="dl_main" style="display:block;">'+NewLine;
					n2+='<a href="http://jk.haomeit.com/shimianzheng/?banyuetan" target="_blank"><img src="http://static.adx.haomeit.com/static/half.a.month/web/images/img6.gif" width="120" height="240"/></a>';
					/*n2+='            <a href="http://jk.haomeit.com/guitouyan/?banyuetan" class="dl_a_link1 fk_purple font_size4" target="_blank"><i>龟头炎怎么治</i></a>'+NewLine;
					n2+='            <div class="dl_rg">'+NewLine;
					n2+='                <a href="http://jk.haomeit.com/xiaoernt/?banyuetan" class="dl_a_link2 fk_light_red font_size2" target="_blank"><i>脑瘫能治好吗</i></a>'+NewLine;
					n2+='                <a href="http://jk.haomeit.com/meidu/?banyuetan" class="dl_a_link3 fk_pink font_size2" target="_blank"><i>梅毒能治愈吗</i></a>'+NewLine;
					n2+='            </div>'+NewLine;*/
					n2+='        </div>'+NewLine;
					n2+='    </div>'+NewLine;

					array.push({num:1,html:n1.replace(/{www}/ig,$G.Config.www_static)});
					array.push({num:2,html:n2.replace(/{www}/ig,$G.Config.www_static)});
					return array;
				}();
				...
				var dfList=new Array(dfData[0],dfData[1],{num:3,html:true});
				for(var i=0,n=o.data.length;i<n;i++){
					var d=o.data[i];
					if(d.num!=(i+1) && d.num!=3){
						if(d.num==1){
							dfList[i]=o.data[0];
						}
					}else{
				...
				var show=function(html,WinAltDom,isTrue){
					if(isTrue){
						$G('div:dl_img',WinAltDom[0]).show();
						$G('div:main',WinAltDom[0]).none();
					}
					WinAltDom.WinAlt({
						position:'fixed',
						isBottom:true,
					...
					$G('div:close_link',WinAltDom[0]).click(function(){
				...
				$G.Each(function(i){
					...
					,	hrefUrl=o.targetUrl
					,	wIm=''
					,	htmlStr=j.num==3?$G.Config.htmlStr250():$G.Config.htmlStr()
					,	isTrue=false
					;
					if(j && !$G.isNaN(j.filePath)){
						j.filePath=wwwImg+j.filePath.replace(new RegExp('http://images.adx.haomeit.com','ig'),'');
						if(j.creativeId){
					...
					var reg=wrParam('name',this+'');
					htmlStr=htmlStr.replace(reg.key,reg.val);
					var div=document.createElement('div');
					div.innerHTML=htmlStr;
					document.body.appendChild(div);
					var WinAltDom=$G('.'+this);
					if(j.num==3){
						show(htmlStr,WinAltDom,isTrue);
					}else if(i==0){
						WinAltDom.WinAlt({
							position:'fixed',
							isLeft:true,
...
(function(){
	var param={
		cabin:'TI25F6RQ4ACJEL,TI2678IK4ACJIU,TI21PTBQ4ACJ7U'
	,	param:{
			trust:7086
		,	style:'www.banyuetan.org'
		}
	,	callback:function(n){
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3Fa1d30e8e1ca1313eb27a0e37fc4e5009' type='text/javascript'%3E%3C/script%3E"));
