window.headerEnd(function(){
	window.account=function(){
		...
		,	toolHtml2='<a name="edit" value="{ACCOUNT_ID}" style="{toolCss};{editDisplay};" >修改</a><a id="w60" name="ini" value="{ACCOUNT_ID}" style="{toolCss}" >安全设置</a><a href="/tologin.shtml?accountId={ACCOUNT_ID}" target="_blank">管理</a>'
		,	list=window.subAjax('div:conditions',{
				...
				,	callback:function(JSON){
						...
						for(var i=0;i<n;i++){
							...
							if(window.wm.data['user']['ACCOUNT_NAME']=='运营'){
